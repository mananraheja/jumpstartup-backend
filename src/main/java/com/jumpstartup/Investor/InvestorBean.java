...
public class InvestorBean {
    ...
    public InvestorBean(String uuid, String phone_number, String domain, String funding_available, String brands_built, String institution, String degree, String major, String year_of_completion, String work_experience) {
        this.uuid = uuid;
