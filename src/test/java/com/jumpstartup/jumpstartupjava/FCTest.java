...
public class FCTest {
    ...
    public void testAddFreelancerData() {
        ...
        ResponseEntity<String> response = controller.addFreelancerData(freelancer);
    ...
    public void testGetFreelancer() {
        ...
        freelancerMock.setUsername("John Doe");
        freelancerMock.setEmail("john.doe@gmail.com");
        ...
        assertEquals("John Doe", freelancer.getUsername());
        assertEquals("john.doe@gmail.com", freelancer.getEmail());
