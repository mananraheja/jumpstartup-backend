...
//        PreparedStatement statement = mock(PreparedStatement.class);
        ...
        doReturn(connection).when(databaseConnector).getConnection();
        ...
        // Create object being tested using dependency injection
        freeLancerDatabase = new FreeLancerDatabase(databaseConnector);
